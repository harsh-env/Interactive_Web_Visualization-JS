...
2. Create a horizontal bar chart with a dropdown menu to display the top 10 OTUs found in that individual.
  ...
  * Use `otu_labels` as the hovertext for the chart.
  ...
  ![bar Chart](Belly_Button_Biodiversity\Images\Images-Pre\hw01.png)
...
![Bubble Chart](Belly_Button_Biodiversity\Images\Images-Pre/bubble_chart.png)

4. Display the sample metadata, i.e., an individual's demographic information.

5. Display each key-value pair from the metadata JSON object somewhere on the page.

![hw](Belly_Button_Biodiversity\Images\Images-Pre/hw03.png)
...
![hw](Belly_Button_Biodiversity\Images\Images-Pre/hw02.png)
...
![Weekly Washing Frequency Gauge](Belly_Button_Biodiversity\Images\Images-Pre/gauge.png)
